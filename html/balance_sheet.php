...
class BalanceSheet extends Common
{
	...
	protected function displayHtml()
	{
		...
		$defaultSessionData['orderByColumn'] = 'a';
	...
	protected function initiateEditor()
	{
		...
		$tableColumns['balance'] = array(
			'display_text' => 'Balance', 
			'perms' => 'VCTXQ', 
		);
		
		$tableName = 'balance_sheet_view';
		$primaryCol = 'a';
		...
		$this->Editor->setConfig('orderByColumn','a');
		$this->Editor->setConfig('tableTitle','Balance Sheet<div style="font-size: 12px; font-weight: normal;"></div>');
